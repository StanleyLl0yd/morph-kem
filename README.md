...
**M0–M5, BTTS/Pachner calibrations T0–T1, and HGES controls G0–G13 are implemented and rejected. The H/Escher/covering and K0–K2.3 side tracks have also produced only negative results. No candidate primitive exists.**
...
The next controlled HGES experiment is **G14**, not a trapdoor construction. G13 shows that a naive random cubic-dual configuration model is not even a healthy simplicial-surface sampler without extreme rejection conditioning.
