...
class HGA1MarkoffActionTests(unittest.TestCase):
    ...
    def test_public_word_reduction_cancels_only_involution_pairs(self) -> None:
        self.assertEqual(reduce_involutive_word((0, 0)), ())
        self.assertEqual(reduce_involutive_word((0, 1, 1, 2)), (0, 2))
        self.assertEqual(reduce_involutive_word((0, 1, 0)), (0, 1, 0))
        with self.assertRaises(HGA1Error):
            reduce_involutive_word((3,))
    ...
    def test_public_bfs_attacks_recover_without_reference_word(self) -> None:
        ...
        self.assertTrue(is_reduced_word(bidirectional.recovered_word))
